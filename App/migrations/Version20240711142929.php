 ...
 */
final class Version20240711142929 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `player` (id INT AUTO_INCREMENT NOT NULL, team_id INT DEFAULT NULL, lastname VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, position VARCHAR(255) NOT NULL, is_coach TINYINT(1) DEFAULT NULL, image_path VARCHAR(255) DEFAULT NULL, INDEX IDX_98197A65296CD8AE (team_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

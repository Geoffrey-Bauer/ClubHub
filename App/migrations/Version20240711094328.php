 ...
 */
final class Version20240711094328 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE stats (id INT AUTO_INCREMENT NOT NULL, player_id INT NOT NULL, battle_id INT NOT NULL, goal INT NOT NULL, assists INT NOT NULL, yellow_card INT NOT NULL, red_card INT NOT NULL, time VARCHAR(50) DEFAULT NULL, INDEX IDX_574767AA99E6F5DF (player_id), INDEX IDX_574767AAC9732719 (battle_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
